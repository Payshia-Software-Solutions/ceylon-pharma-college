...
const config = {
  ...
  CERTIFICATE_URL: "http://localhost/pharma-college-project/certificate-generator",
  CERTIFICATE_IMG_URL: "https://content-provider.pharmacollege.lk/content-provider/certificates",
