export default function CourseSidebar({ duration, schedule, level, price }) {
    return (
      <div className="bg-white rounded-xl shadow-lg overflow-hidden sticky top-24">
            ...
            <div className="mb-4">
              ...
              <ul className="space-y-2">
                {["Pass in Mathematics OR Science in GCE O/L", 
                  ...
                  "Diploma or Certificate in Allied Health Sciences"].map((item, index) => (
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["At least 3 months experience as a Pharmacy Assistant", 
                  ...
                  "Experience in a healthcare facility or pharmacy"].map((item, index) => (
                  <li key={index} className="flex items-start">
                    <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
        ...
        <div className="bg-green-50 p-6">
          ...
          <ul className="space-y-2">
            {["Printed study materials", "Notebooks", "Mobile phone mount", 
              "Games book", "Pen", "Exam book", "Image book"].map((item, index) => (
              <li key={index} className="flex items-start">
