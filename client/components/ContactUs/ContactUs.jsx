          ...
          <div className="w-full md:w-2/3 bg-white rounded-md p-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 gap-6">
                <Input name="full_name" placeholder="Full Name" type="text" value={formData.full_name} onChange={handleChange}  required/>
                <Input name="email" placeholder="Email" type="email" value={formData.email} onChange={handleChange} required />
                <Input name="phone_number" placeholder="Phone Number" type="tel" value={formData.phone_number} onChange={handleChange}  required/>
                <Input name="subject_topic" placeholder="Subject Topic" type="text" value={formData.subject_topic} onChange={handleChange} required />
              </div>
              <textarea
                name="message"
                placeholder="Message"
