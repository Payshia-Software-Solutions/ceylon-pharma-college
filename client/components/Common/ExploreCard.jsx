  ...
  return (
    <>
      <Link href={`/course/${slug}`}>
        <div className="max-w-full max-h-[38rem] sm:max-w-[20rem] md:max-w-[24rem] lg:max-w-[28rem] my-5 rounded-lg overflow-hidden shadow-lg border border-gray-200 bg-white md:hover:scale-105 transition-transform duration-300">
          {/* Image */}
          <img
