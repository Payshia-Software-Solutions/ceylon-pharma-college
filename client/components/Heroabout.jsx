...
function Heroabout() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full overflow-hidden bg-gray-50">
      ...
      <div className="w-full md:w-1/2 p-4 py-8 md:p-12 flex flex-col justify-center ">
        ...
        <p className="text-gray-700 mb-6 text-center md:text-left">
          ...
          launchpad for your dreams. At Ceylone Pharma College, you'll gain the
          knowledge, skills, and confidence needed to excel in your chosen
